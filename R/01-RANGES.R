...
MEDICAID_HOSPITAL_RANGE_NAMES_LONG = list(
...
FACILITY_RANGES = list(
  ...
  "1000-1199" = as_sf(4600:4799), # HERE
  "1000-1199" = as_sf(4900:4999),
  "1000-1199" = as_sf(1500:1799),
  "1000-1199" = as_sf(1990:1999),
  "1000-1199" = as_sf(2000:2299),
