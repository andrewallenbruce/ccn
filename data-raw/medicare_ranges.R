medicare_ranges <- tibble::tribble(
  ~start , ~end  , ~range      , ~abbr      , ~desc                                                        ,
   ...
   880L  ,  899L , "0880-0899" , "OCM"      , "Hospital in Oncology Care Model Demonstration Project"      ,
  ...
  2300L  , 2499L , "2300-2499" , "ESRD-H"   , "Hospital-based Renal Dialysis Facility"                     ,
  2500L  , 2899L , "2500-2899" , "ESRD-I"   , "Independent Renal Dialysis Facility"                        ,
  2900L  , 2999L , "2900-2999" , "ESRD-IP"  , "Independent Special Purpose Renal Dialysis Facility"        ,
  3000L  , 3024L , "3000-3024" , "TBH"      , "Tuberculosis Hospital (Retired)"                            ,
  3025L  , 3099L , "3025-3099" , "IRF"      , "Rehabilitation Hospital"                                    ,
  3100L  , 3199L , "3100-3199" , "HHA-NP"   , "Home Health Agency Subunit (Non/Prop)"                      , # "Home Health Agency",
  ...
  6990L  , 6999L , "6990-6999" , "Reserved" , "Number Reserved (Formerly CSS)"                             ,
  # 7000L  , 8499L , "7000-8499" , "HHA"      , "Home Health Agency",
  7000L  , 7299L , "7000-7299" , "HHA"      , "Home Health Agency"                                         ,
  7300L  , 7399L , "7300-7399" , "HHA-NP"   , "Home Health Agency Subunit (Non/Prop)"                      ,
  7400L  , 7799L , "7400-7799" , "HHA"      , "Home Health Agency"                                         ,
  7800L  , 7999L , "7800-7999" , "HHA-SL"   , "Home Health Agency Subunit (State/Local)"                   ,
