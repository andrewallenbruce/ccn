medicaid_types <- tibble::tribble(
  ~code , ~abbr     , ~desc                                                                       ,
  "A"   , "SNF-NF"  , "Nursing Facility"                                                          , #  (Formerly Assigned to Medicaid SNF)
  "B"   , "SNF-NF"  , "Nursing Facility"                                                          , #  (Formerly Assigned to Medicaid SNF)
  "E"   , "SNF-NF"  , "Nursing Facility"                                                          , #  (Formerly Assigned to ICF)
  "F"   , "SNF-NF"  , "Nursing Facility"                                                          , #  (Formerly Assigned to ICF)
